...
`);
    ...
    const handleEventTarget = (event) => {
        ...
        console.log(target);
        $(target).css('backgroundColor', 'blue').css('color', 'white');
    }
    ...
    //click: call function in the parameter when click the selected part
    
}
$(init);
//PASS INIT FUNCTION TO THE global function called jQuery and its alias $
